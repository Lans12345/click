...
class SearchedSearviceInSearchIcon extends StatefulWidget {
  const SearchedSearviceInSearchIcon({Key? key}) : super(key: key);

  @override
  State<SearchedSearviceInSearchIcon> createState() =>
...
class _SearchedProductInSearchIconState
    extends State<SearchedSearviceInSearchIcon> {
  @override
  void initState() {
    super.initState();
    getData();
