import 'package:dotcom/searched/searchedOffers.dart';
import 'package:dotcom/util/regions.dart';
import 'package:flutter/material.dart';
import 'package:shared_preferences/shared_preferences.dart';

class SearchRegionOffers extends StatefulWidget {
  const SearchRegionOffers({Key? key}) : super(key: key);

  @override
  State<SearchRegionOffers> createState() => _SearchRegionOffersState();
}

class _SearchRegionOffersState extends State<SearchRegionOffers> {
                  ...
                  InkWell(
                    onTap: () async {
                      ...
                      Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) => const SearchedOffers()));
                    },
