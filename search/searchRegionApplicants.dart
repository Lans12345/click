import 'package:dotcom/searched/searchedApplicants.dart';
import 'package:dotcom/util/regions.dart';
import 'package:flutter/material.dart';
import 'package:shared_preferences/shared_preferences.dart';

class SearchRegionApplicants extends StatefulWidget {
  const SearchRegionApplicants({Key? key}) : super(key: key);

  @override
  State<SearchRegionApplicants> createState() => _SearchRegionApplicantsState();
}

class _SearchRegionApplicantsState extends State<SearchRegionApplicants> {
                  ...
                  InkWell(
                    onTap: () async {
                      ...
                      Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) => const SearchedApplicants()));
                    },
