import 'package:dotcom/category/selectProduct.dart';

import 'package:dotcom/util/regions.dart';
import 'package:flutter/material.dart';
import 'package:shared_preferences/shared_preferences.dart';

class SearchRegionProducts extends StatefulWidget {
  const SearchRegionProducts({Key? key}) : super(key: key);

  @override
  State<SearchRegionProducts> createState() => _SearchRegionProductsState();
}

class _SearchRegionProductsState extends State<SearchRegionProducts> {
